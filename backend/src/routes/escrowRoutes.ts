...
import { createEscrow, getEscrows, getEscrowDetails, fundEscrow, updateEscrowStatus, releaseFunds, verifyPayment, raiseDispute, deleteEscrow } from '../controllers/escrowController';
...
router.delete('/:id', authenticate, deleteEscrow);
